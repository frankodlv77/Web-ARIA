        ...
        <footer className="mt-24 md:mt-32 pt-12 border-t border-kova-border">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12 mb-12">
            ...
            <div className="max-w-xs">
              ...
              <p className="text-sm text-kova-gray leading-relaxed mb-5">
                Diseño, desarrollo y automatización con IA para negocios que quieren escalar.
              </p>
              <p style={{ fontSize: '11px', color: '#2A2A2A', fontWeight: 600, marginBottom: '10px' }}>
                Franco De La Vega — Fundador
              </p>
              <div className="flex items-center gap-4">
                <a href="https://www.linkedin.com/in/franco-delavega/" target="_blank" rel="noopener noreferrer"
                  style={{ color: '#AAAAAA', display: 'flex', alignItems: 'center', gap: '6px' }}
                  className="hover:text-kova-dark transition-colors" title="LinkedIn">
                ...
                <a href="https://www.instagram.com/franco.de.la.vega/" target="_blank" rel="noopener noreferrer"
                  style={{ color: '#AAAAAA', display: 'flex', alignItems: 'center', gap: '6px' }}
                  className="hover:text-kova-dark transition-colors" title="Instagram">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="mailto:hola@vora-system.com"
                  style={{ color: '#AAAAAA', display: 'flex', alignItems: 'center', gap: '6px' }}
                  className="hover:text-kova-dark transition-colors" title="hola@vora-system.com">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="2" y="4" width="20" height="16" rx="2"/>
                    <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
                  </svg>
                  <span style={{ fontSize: '11px', letterSpacing: '0.05em' }}>Email</span>
                </a>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 border-t border-kova-border pt-6">
            <span className="text-xs text-kova-dark/25">© 2026 VORA</span>
